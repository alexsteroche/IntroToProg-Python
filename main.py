...
# Alex Rochester 2.18.2021 ,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
...
for line in objFile:
    strData = line.split(",")  #this splits the lines where it finds ,
    dicRow = {"Task": strData[0].strip(), "Priority": strData[1].strip()} #this assigns the split data from the previous line into the two rows "task" and "priority"
    lstTable.append(dicRow) #this will allow new data to be appended to the dictionary
objFile.close()
